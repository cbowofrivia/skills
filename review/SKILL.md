...
- `docs/plans/*.md` — Plan files created by `/workflow:plan`. These are living documents that track implementation progress (checkboxes are checked off by `/workflow:work`).
